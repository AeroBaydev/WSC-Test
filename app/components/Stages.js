...
export default function Stages() {
  const stages = [
    ...
    },
    {
      ...
      icon: "🏆",
      color: "bg-orange-600",
      date: "30th September 2025 (Tentative)",
    },
    {
      stage: "Stage 3",
            ...
            <div className="relative orange-accent rounded-2xl p-8 md:p-12 text-center card-shadow-lg border-4 border-orange-200">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-white">
                ...
                >
                  ...
                  <p className="text-orange-100 text-sm">30th September 2025</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  className="bg-white/20 rounded-xl p-6 backdrop-blur-sm border border-white/30"
                >
                  ...
                  <p className="text-orange-100 text-sm">30th September 2025 (Tentative)</p>
                </motion.div>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  className="bg-white/20 rounded-xl p-6 backdrop-blur-sm border border-white/30"
